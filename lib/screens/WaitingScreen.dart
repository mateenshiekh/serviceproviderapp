...
import 'package:quickcallout/screens/WaitingScreen2.dart';
import 'package:quickcallout/widgets/custom_Rect_Button.dart';

class WaitingScreen extends StatefulWidget {
  final Color mainColor;
  WaitingScreen({Key key, @required this.mainColor}) : super(key: key);
          ...
          children: <Widget>[
            Column(
              children: <Widget>[
                ...
                RoundedCustomButton(
                  lable: "BOOKING IS CONFIRMED",
                  textColor: Colors.white,
                  buttonColor: appgreenColor,
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => WaitingScreenCounter(mainColor: widget.mainColor,)));
                  },
                ),
              ],
            ),
